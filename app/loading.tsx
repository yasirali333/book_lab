  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-200">
      <div className="loader-container">
        ...
        >
          <path
            d="M100 50C100 77.6142 77.6142 100 50 100C22.3858 100 0
          ...
          14.8717C30.5992 14.8717 14.8717 30.5992 14.8717 50Z"
            fill="#BDBDBD"
            fillOpacity="0.666667"
          />
          <path
            d="M50 0C42.5229 -8.91634e-08 35.141 1.67695 28.3978 4.90738C21.6546
